...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/mcp-demo)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/mcp-demo
```

A live public deployment of this template is available at [https://mcp-demo.templates.workers.dev](https://mcp-demo.templates.workers.dev)
